...
const FeaturedHero = ({ articles }: { articles?: any[] }) => {
  const source = Array.isArray(articles) && articles.length > 0 ? articles : mockArticles;
  const featured = source.find((a) => a.isFeatured) || source[0];
