        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-start text-left">
          ...
          <div className="space-y-3">
            ...
            <div className="mt-4 flex items-center gap-3">
              ...
              <a href="https://www.youtube.com/@lesasdelapresse7865" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="social-icon social-icon-youtube social-icon-animate text-gray-400 hover:text-white">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
